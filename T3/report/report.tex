...
Outra análise foi feita para avaliar a ocorrência dos \emph{Newsgroup}. O Gráfico \ref{fig:occurrence_word} apresenta as maiores ocorrências de cada \emph{Newsgroup} individualmente, considerando todas as palavras-chave que o compõe.
...
A partir do Gráfico \ref{fig:occurrence_word}, é possível visualizar que quase $8.000$ dados apresentam informação de \emph{Newgroup}

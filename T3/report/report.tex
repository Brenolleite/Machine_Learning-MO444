...
\begin{figure}[!h]
	\centering
	{
		\fbox{\includegraphics[scale=0.20]{Images/elbow.png}}
	}
...
\begin{figure}[!h]
	\centering
	{
		\fbox{\includegraphics[scale=0.20]{Images/silhueta.png}}
	}
...
\begin{figure}[!h]
	\centering
	{
		\fbox{\includegraphics[scale=0.20]{Images/occurrence.png}}
	}
...
\begin{figure}[!h]
	\centering
	{
		\fbox{\includegraphics[scale=0.20]{Images/occurence_word.png}}
	}
...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|c|c|}		
		...
		1                    & \textbf{d973d26ed60d7c6e21017dd9e543c19666c0b8e1} & comp.windows.x                                                & Given that all the \textbf{source} code contains explicit permission ...                                                                             \\ \hline
		1                    & 65840edcd1c36154cc7b5e8f547f68582416d7f0          & comp.windows.x, news.answers, comp.answers                    & Float resources are not portable; the size of the value may be larger thanthe size of an XtPointer ...                                      \\ \hline
		1                    & b4a4f9a27f9aaf185f6691f2ec3c4f8f41823d27          & sci.med                                                       & but just because the net is a \textbf{source} of large amounts of bizarre ...                                                                        \\ \hline
		2                    & \textbf{ecf5e152282746632776b8e4ec1ee7d11ce7c37c} & talk.politics.misc,soc.culture.canada                         & In the world of the future, Bill Clinton will appoint Canadians to ...                                                                      \\ \hline
		2                    & 1a21a4e42a3649cc741fa6f94c818aa45be589ed          & talk.abortion,alt.atheism,talk.religion.misc                  & If I can predict with almost 100\% accuracy that Americans prefer to own their portions of the US ...                                       \\ \hline
		2                    & 6e8b424c0b791f4dcce6e757705d8e85bf602a22          & talk.politics.misc,alt.politics.clinton,alt.fan.rush-limbaugh & The Democrats ran,one of their best campaigns in years against a pathetic Republican ... \\ \hline
	\end{tabular}
	}
...
\begin{figure}[!h]
	...
	\subfloat[K = 79]{
		{
			\fbox{\includegraphics[scale=0.081]{Images/tsne79}}
		}
		\label{fig:tsne79}
	}
